...
colores = ["roja", "blanca", "amarilla", "verde"]
naciones = ["aleman", "ingles", "danes", "britanico"]
mascotas = ["pez", "caballo", "perro", "gato", "pajaro"]
bebidas = ["te", "cafe", "cerveza", "agua"]
        ...
        for mas1 in mascotas:
            for beb1 in bebidas:
                for cig1 in cigarros:
                    fin = time.time()
                    if (vuelta == 0):
                        print("probando combinacion " + str(prueba) + " tiempo empleado: " + str(
                            fin - inicio) + " tiempo estimado: "
                                                                    ...
                                                                    for mas4 in mascotas4:
                                                                        for beb4 in bebidas4:
                                                                            for cig4 in cigarros4:
                                                                                ...
                                                                                col5 = list(set(colores) - set(
                                                                                    [col1, col2, col3, col4]))
                                                                                nac5 = list(set(naciones) - set(
                                                                                    [nac1, nac2, nac3, nac4]))
                                                                                mas5 = list(set(mascotas) - set(
                                                                                    [mas1, mas2, mas3, mas4]))
                                                                                beb5 = list(set(bebidas) - set(
                                                                                    [beb1, beb2, beb3, beb4]))
                                                                                cig5 = list(set(cigarros) - set(
                                                                                    [cig1, cig2, cig3, cig4]))
                                                                                # Creamos cada combinacion valida
                                                                                prueba = prueba + 1
                                                                                casas = []
                                                                                casas.append(
                                                                                    Casa(col1, "noruego", mas1, beb1,
                                                                                         cig1))
                                                                                casas.append(
                                                                                    Casa("azul", nac2, mas2, beb2,
                                                                                         cig2))
                                                                                casas.append(
                                                                                    Casa(col3, nac3, mas3, "leche",
                                                                                         cig3))
                                                                                casas.append(
                                                                                    Casa(col4, nac4, mas4, beb4, cig4))
                                                                                casas.append(
                                                                                    Casa(col5, nac5, mas5, beb5, cig5))
                                                                                checaCondiciones(casas)
for casa in casas:
    print(casa.color + casa.nacion +casa.mascota + casa.bebida + casa.cigarro)